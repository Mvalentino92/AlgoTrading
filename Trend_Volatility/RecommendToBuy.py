...
symbols = filter_stocks(api,av,n=150,t=15,exchange='NASDAQ',low=15,high=85)
...
w4 = np.array([0.5,0.3,0.2]) # (trend,vol,mr)

# Get recommended to buy and put in plot
recos = recommend_to_buy(api,av,symbols,w1,w2,w3,w4,Ns,M=5)
